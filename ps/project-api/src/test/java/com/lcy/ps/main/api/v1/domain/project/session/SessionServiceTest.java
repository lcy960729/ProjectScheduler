...
//import com.lcy.ps.core.dto.request.session.AddMembersToSessionDTO;
...
//
//            // when
//            Session session = sessionService.create(user.getId(), project.getId(), createSessionDTO);
//
//            // then
...
//
//            Assertions.assertThat(sessionMembers).hasSize(1);
//
//            SessionMember sessionMember = sessionMembers.stream().findFirst().get();
//
//            Assertions.assertThat(sessionMember.getState()).isEqualTo(MemberState.JOINED);
//            Assertions.assertThat(sessionMember.getSessionPermission()).isEqualTo(SessionPermission.MANAGER);
//        }
//
//        @Test
...
//            // then
//            Set<SessionMember> sessionMembers = session.getSessionMembers();
//            Assertions.assertThat(sessionMembers).hasSize(2);
//
...
//        void setState() {
//            // given
//            Session tempSession = sessionService.create(user.getId(), project.getId(), createSessionDTO);
//
//            // when
...
//
//            Assertions.assertThat(session.getState()).isEqualTo(inProgressState);
//        }
//
//
//    }
...
//
//            // when
//            Throwable throwable = catchThrowable(() -> sessionService.create(other.getId(), project.getId(), createSessionDTO));
//
//            // then
